...
export const FAQ: Record<FaqLang, FaqLanguage> = {
  uz: {
    ...
    answers: {
      ...
      deposit:  `💳 30% avans nima?\n\nBu buyurtmangizni tasdiqlash uchun oldindan to'lanadigan qism. Masalan, 300,000 so'mlik lookda siz 90,000 so'm avans to'laysiz. Qolgan qism mahsulot yetib kelganda to'lanadi.\n\nBu bizning ehtiyot choramizdir — ba'zi mijozlar tovar yetkazib berilganidan keyin to'lashdan bosh tortishi mumkin. Avans bu holatdan himoya qiladi.\n\n⚠️ Avans qaytarilmaydi.`,
      cancel:   `❌ Buyurtmani bekor qilish mumkin emas\n\nBuyurtma berilgandan so'ng, biz darhol Xitoydan jo'natmani boshlaymiz. To'lov allaqachon amalga oshirilgan va buyurtma bekor qilinmaydi. Pullar qaytarilmaydi.`,
      ...
      quality:  `✅ Sifat haqida\n\nBiz sotayotgan barcha kiyimlarni oldindan o'zimiz uchun buyurtma qilib, sifatini shaxsan tekshirganmiz.\n\nKiyimlar yaxshi sifatda — kundalik foydalanish uchun mos. Lekin bu arzon narxdagi mahsulot ekanligini hisobga oling: premium yoki original brend sifatini kutmang. Narxiga mos sifat kafolatlanadi.`,
  ...
  en: {
    ...
    answers: {
      ...
      deposit:  `💳 What is the 30% deposit?\n\nIt is the part of the payment you make upfront to confirm your order. For example, for a 300,000 UZS look you pay 90,000 UZS now. The rest is paid on delivery.\n\nThis is our precaution — some customers may refuse to pay after the product is delivered. The deposit protects against that.\n\n⚠️ The deposit is non-refundable.`,
      cancel:   `❌ Orders cannot be cancelled\n\nOnce an order is placed, we immediately begin shipping from China. The payment has already been made — the order cannot be cancelled and no refunds are issued.`,
